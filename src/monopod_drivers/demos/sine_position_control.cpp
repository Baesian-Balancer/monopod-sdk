...
void SinePositionControl::loop()
{
    ...
    while (!stop_loop_)
    {
        ...
        {
            actual_position = leg->get_measurement(i, blmc_position_index)
                                  ->newest_element();
            actual_velocity = leg->get_measurement(i blmc_velocity_index)
                                  ->newest_element();
            actual_current = leg->get_measurement(i, blmc_current_index)
                                 ->newest_element();
            ...
            leg->set_current_target(desired_current, i);
        }
