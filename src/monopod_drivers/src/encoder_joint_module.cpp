...
{
    return get_encoder_measurement(MeasurementIndex::position) / gear_ratio_ - zero_angle_;
}
...
double EncoderJointModule::get_zero_angle() const
{
    return zero_angle_;
}

double EncoderJointModule::get_encoder_measurement(const MeasurementIndex& measurement_id) const
{
