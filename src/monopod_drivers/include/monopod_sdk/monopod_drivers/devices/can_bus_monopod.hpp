...
//==============================================================================
/**
 * @brief This MonopodCommand class is a data structurs that defines a
 * command.
 */
class MonopodCommand
{
public:
    /**
     * @brief Construct a new MonopodCommand object
     */
    MonopodCommand()
    {
    }
     ...
     */
    MonopodCommand(uint32_t id, int32_t content)
    {
        id_ = id;
        content_ = content;
    }
...
//==============================================================================
/**
 * @brief MonopodInterface declares an API to inacte with a Monopod.
 */
class MonopodInterface : public DeviceInterface
{
public:
    /**
     * @brief Destroy the MonopodInterface object
     */
    virtual ~MonopodInterface()
    {
    }
     ...
     * @brief A useful shortcut
     */
    typedef time_series::TimeSeries<MonopodStatus> StatusTimeseries;
    /**
     * @brief A useful shortcut
     */
    typedef time_series::TimeSeries<MonopodCommand> CommandTimeseries;
    /**
     * @brief A useful shortcut
     */
     ...
     */
    virtual void set_command(const MonopodCommand& command) = 0;
...
//==============================================================================
/**
 * @brief This class CanBusMonopod implements a MonopodInterface specific
 * to CAN networks.
 */
class CanBusMonopod : public MonopodInterface
{
public:
    /**
     * @brief Construct a new CanBusMonopod object
     *
     * @param can_bus
     * @param history_length
     */
    CanBusMonopod(std::shared_ptr<monopod_drivers::CanBusInterface> can_bus,
                     const size_t& history_length = 1000,
                     const int& control_timeout_ms = 100);

    /**
     * @brief Destroy the CanBusMonopod object
     */
    ~CanBusMonopod();
    ...
    /**
     * @brief Set the controls, see MonopodInterface::set_control
     *
     * @param control
     * @param index
     */
    ...
    /**
     * @brief Set the commands, see MonopodInterface::set_command
     *
     * @param command
     */
    virtual void set_command(const MonopodCommand& command)
    {
...
private:
    ...
    {
        ((CanBusMonopod*)(instance_pointer))->loop();
...
private:
     ...
     */
    std::shared_ptr<monopod_drivers::CanBusInterface> can_bus_;
